...
interface RiotApiService {
    ...
    @GET("lol/summoner/v4/summoners/by-name/{summoner_name}?api_key=RGAPI-86a455c9-1583-4e0c-8409-f2c6fb0a6eaa")
    fun getUserData(@Path(value = "summoner_name", encoded = true) summonerName : String) : retrofit2.Call<UserDto>

    @GET("lol/champion-mastery/v4/champion-masteries/by-summoner/{summonerId}?api_key=RGAPI-86a455c9-1583-4e0c-8409-f2c6fb0a6eaa")
    fun getChampionSkill(@Path(value = "summonerId", encoded = true) summonerId : String) : retrofit2.Call<List<ChampSkillInfo>>

    @Headers(
        "X-Riot-Token: RGAPI-86a455c9-1583-4e0c-8409-f2c6fb0a6eaa"
    )
